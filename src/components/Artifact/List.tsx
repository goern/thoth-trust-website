...
function ArtifactListActions(props: ArtifactListActionsProps) {
...
export default function ArtifactList({ rows }: ArtifactListProps) {
  ...
  return (
    <TableContainer component={Paper}>
      <Table sx={{ minWidth: 500 }} aria-label="artifact list pagination table">
        <TableBody>
          {(rowsPerPage > 0
        ...
        <TableFooter>
          <TableRow>
            <TablePagination
              ...
              ActionsComponent={ArtifactListActions}
            />
          </TableRow>
        </TableFooter>
      </Table>
